...
export const Route = createFileRoute("/compare")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Compare Logo Variations — Clouds & Spirits Draft 02" },
      {
    ...
    <>
      ...
      <ChoiceGroup
        ...
        options={[
          ...
          { value: "variation-05", label: "Variation 05" },
          { value: "variation-06", label: "Variation 06" },
          { value: "variation-07", label: "Variation 07" },
          { value: "variation-08", label: "Variation 08" },
