...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Itd7iiY3.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-W5KpDBpB.mjs").then((n) => n.t),
		import("./start-B1UmtR1Y.mjs"),
...
//#endregion
export { server_exports as a, server_default as i, createMiddleware as n, createServerEntry as r, createCsrfMiddleware as t };
